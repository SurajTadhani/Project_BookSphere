...
<div className="card md:w-96  bg-base-100 shadow-xl   dark:bg-slate-900 dark:text-white border-[1px] dark:border cursor-pointer">
  <figure><img className='lg:h-80 w-auto h-64 hover:scale-95 duration-500 overflow-hidden' src={items.image} alt="Shoes" /></figure>
  <div className="p-5">
    ...
    <div className="card-actions flex justify-between py-5">
      ...
      <div>
      <button className="btn btn-outline rounded-2xl dark:text-white"  onClick={() => onReadNow(items)}>Read Now</button>
      </div>
    </div>
  </div>
</div>
