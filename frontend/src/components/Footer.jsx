...
function Footer() {
  return (
    ...
    <footer className="footer md:p-10 p-4 bg-base-200 text-base-content dark:bg-slate-900 dark:text-white dark:border">
  <nav className=''>
...
<footer className="footer px-20 py-4 border-t bg-base-200 text-base-content border-base-300 dark:bg-slate-900 dark:text-white dark:border">
  <aside className="items-center grid-flow-col">
    ...
    <p>BOOKSTORE Industries Ltd. <br/>Providing reliable tech since 1992</p>
  </aside> 
  <nav>
